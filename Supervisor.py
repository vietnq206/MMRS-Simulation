    ...
    def ask_register(self):
        ...
        for idx in range(len(self.robots)):
            if self.robots[idx].state == st_ASK and flag == 0:
                cyc = self.deadlock_detection(idx)
                if len(cyc) != 0:
                    print(cyc)
                    ...
                    # input()
                    # print(self.access_nodes)
                    # print("current node")
                    # print(self.robots[idx].curr_node())
                    # if ((self.robots[idx].curr_node()[0],self.robots[idx].curr_node()[1]+1) in self.access_nodes):

                        # print(len(self.access_nodes))
